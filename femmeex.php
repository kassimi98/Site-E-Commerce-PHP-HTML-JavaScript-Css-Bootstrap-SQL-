      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
         ...
         <!-- <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#femme">Femme</a>
          </li>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div id="main-slider" class="main-slider flexslider">
              <ul class="slides">
                <li>
                  <img src="img/slides/flexslider/Sans titre-2.jpg" alt="" />
            ...
            <p>Duis fermentum auctor ligula ac malesuada. Mauris et metus odio, in pulvinar urna</p>
                ...
                <li>
                  <img src="img/slides/flexslider/femme33.jpg" alt="" />
                  <div class="flex-caption">
                    <h3>Autenticite</h3>
                ...
                <li>
                  <img src="img/slides/flexslider/femme22.jpg" alt="" />
                  <div class="flex-caption">
...
<section class="bg-light" id="portfolio">
  ...
  <h3 class="section-subheading text-muted" align="center">Choisissez Votre Categorie .</h3>
          <div class='col-lg-12 '>
            <?php                    
             $select=$db->query("SELECT DISTINCT categorie FROM productsh WHERE genre='femme'");
      ...
      <?php
          ...
          if ($_GET['action']) {
             ...
             $select=$db->prepare("SELECT * FROM productsh  where  genre=? AND categorie=?  ");
              $select->execute(array('femme',$_GET['action']));
