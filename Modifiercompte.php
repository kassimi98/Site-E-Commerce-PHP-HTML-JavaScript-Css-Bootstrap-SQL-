  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <?php }else{?>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="my_account.php">Mon Compte</a>
          </li>
...
$select=$db->query("SELECT * FROM users WHERE pseudo='$_SESSION['user_pseudo']'");

?>
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Modifier compte</h2>
    ...
    <form id="contactForm" action="" method="POST"  name="sentMessage" novalidate="novalidate">
            <div class="row">
              ...
              <div class="col-md-6" align="center">
                <div class="form-group">
                  <input class="form-control" type="text" placeholder=" Nom et Prènom *" name="nom"
                   id="name" required="required" data-validation-required-message="Please enter your name.">
              ...
              <div class="col-md-6">
                <div class="form-group">
      <textarea class="form-control" placeholder=" Adresse *" name="adresse" required="required" data-validation-required-message="Please enter a message."> <?php ?></textarea>
                  <p class="help-block text-danger"></p>
                </div>
              </div>
    ...
    <button id="sendMessageButton" class="btn btn-primary btn-x text-uppercase" type="submit"  name="submit"><i class="fa fa-sign-in"></i> ENVOYER </button>
              </div>
