...
<br> <br> <br> <br> <br>
  <section id="contact"> 
    ...
    <form id="contactForm" action="" method="POST"  name="sentMessage" novalidate="novalidate">
          ...
          <input class="form-control" type="password" placeholder="Mot de passe *" name="password"
           required="required" data-validation-required-message="enter your password." required>
                ...
                <div class="form-group">
          <input class="form-control" type="password" placeholder="Répeter Mot de passe *" 
    ...
    if (isset($_POST['submit'])){
     ...
     //$passwordhash=password_hash($password,PASSWORD_DEFAULT);
          ...
          echo"<p><font  color='#35d55b'> Vous êtes membre maintenant vous pouvez </font><a  href='connect.php'><font color='#356d50'>Connecter</font></a>.</p>";
  ...
  ?>
           <div class="col-lg-12 text-center">     
      <h2><a href="connect.php">Vous avez Déja un Compte .</a></h2><br>
